...
function initFeedbackModal() {
    if (!openFeedbackBtn || !feedbackModal || !closeModalBtn || !feedbackForm) return;
    ...
    feedbackForm.addEventListener('submit', (e) => {
        ...
        showNotification('Ваше сообщение отправлено! Спасибо за обращение.', 'success');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productionDateElem) {
        productionDateElem.value = today;
    }
